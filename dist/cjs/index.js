 ...
 */
const swagger = ({ provider = 'scalar', scalarVersion = '1.12.5', scalarCDN = "", scalarConfig = {}, documentation = {}, version = '5.9.0', excludeStaticFile = true, path = '/swagger', exclude = [], swaggerOptions = {}, theme = `https://unpkg.com/swagger-ui-dist@${version}/swagger-ui.css`, autoDarkMode = true, excludeMethods = ['OPTIONS'] } = {
    provider: 'scalar',
